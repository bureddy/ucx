...
ucs_status_t (*ucm_mem_type_get_current_device_info[UCS_MEMORY_TYPE_LAST])(int *device_id, ucs_sys_bus_id_t *bus_id);
...
int  ucm_get_mem_type_current_device_info(ucs_memory_type_t memtype, int *device_id, ucs_sys_bus_id_t *bus_id)
{
    ...
    ucm_mem_type_get_current_device_info[memtype](device_id, bus_id);
