                                ...
                                uct_iface_attr_t *iface_attr)
{
    ...
    ucm_get_mem_type_current_device_info(UCS_MEMORY_TYPE_CUDA, &mem_type_device, &bus_id);
    printf("device_id:%d bus_id: %x:%x:%x:%x \n", mem_type_device, bus_id.domain, bus_id.bus, bus_id.slot, bus_id.function);
